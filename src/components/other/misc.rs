...
pub fn AboutMe() -> Html{
    ...
    <div class="flex justify-center -mt-16 lg:justify-end">
        <img class="object-cover w-20 h-20 border-2 border-purple-300 rounded-full" alt="About me Avatar" src="/img/poza.webp"/>
    </div>

    <h2 class="mt-2 text-xl font-bold text-secondary md:mt-0 font-mono">{"About"}</h2>
...
{"I possess extensive experience in structuring and optimizing the layout of power-point presentations."}</p>
    ...
    <div class="flex justify-end mt-4">
        <a href="#" class="text-lg font-mono font-bold text-main" tabindex="0" role="link">{"Tatiana Grigoriev"}</a>
    </div>
</div>
</div>
    }
...
pub fn Contact() -> Html {
    html! {
        ...
        <div class="max-w-screen-lg w-full overflow-hidden bg-slate-50 rounded-lg shadow-lg flex">
        <img class="object-cover object-center w-1/2 h-56" src="/img/contact.svg" alt="avatar"/>
        <div class="px-6 py-4">
            <h1 class="text-xl font-semibold text-main font-mono">{"Get in touch"}</h1>
            ...
            <div class="flex items-center mt-4 text-main">
                ...
                <a class="px-2 text-sm font-mono" href="mailto:tatianagrigoriev7@gmail.com?Subject=Need a presentation">{"tatianagrigoriev7@gmail.com"}</a>
            </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" class="w-6 h-6 fill-current">
                ...
                <a class="px-2 text-sm text-main font-mono" href="https://t.me/Marcelline34"  target="_blank" >{"t.me/Marcelline34"}</a>
            </div>
