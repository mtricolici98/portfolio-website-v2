    ...
    html !{ 
        ...
        <div class="grid max-w-screen-xl px-4 pt-10 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12 lg:pt-16">
            <div class="mr-auto place-self-center lg:col-span-5">
                <h1 class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl">{"Turn your"} <br/> {"presentation"} <br/> {"into an event."} </h1>
                ...
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    ...
                    // </a> 
                    <a href="mailto:tatianagrigoriev7@gmail.com" class="inline-flex items-center justify-center w-full px-5 py-3 mb-2 mr-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg sm:w-auto focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200">
                        {"Get in touch"}
                    </a>
                </div>
            </div>
            <div class="hidden lg:mt-0 lg:col-span-7 lg:flex">
                <img class="" src="img/graphic-main.svg" alt="Main text"/>
            </div>                
        </div>
    </section>
    }
